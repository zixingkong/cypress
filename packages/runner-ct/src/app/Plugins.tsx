...
export const Plugins = namedObserver('Plugins', (props: PluginsProps) => {
  const ref = React.useRef<HTMLDivElement>(null)

  return (
    <Hidden type="visual" hidden={!props.state.isAnyPluginToShow} className={styles.ctPlugins}>
      <div className={styles.ctPluginsHeader}>
        {props.state.plugins.map((plugin) => (
          ...
          >
            ...
            >
              <FontAwesomeIcon icon="chevron-up" className={styles.ctPluginsName} />
            </div>
          </button>
        ))}
      </div>
