  ...
  context('integration', () => {
    ...
    describe('get:cookies', () => {
      ...
      it('returns all cookies', function (done) {
        ...
        return this.server.emit('automation:request', 123, 'get:cookies', {
          domain: 'google.com',
        })
      })
    })
    ...
    describe('get:cookie', () => {
      ...
      it('returns a specific cookie by name', function (done) {
        ...
        return this.server.emit('automation:request', 123, 'get:cookie', {
          domain: 'google.com',
          name: 'session',
        })
      })
    ...
    describe('clear:cookies', () => {
      ...
      it('resolves with array of removed cookies', function (done) {
        ...
        return this.server.emit('automation:request', 123, 'clear:cookies', {
          domain: 'google.com',
        })
      })
      ...
      it('rejects when no details', function (done) {
        this.socket.on('automation:response', (id, obj = {}) => {
          ...
          expect(obj.__error).to.eq(
            `Removing cookie failed for: ${JSON.stringify({
              url: 'http://no.details/',
              name: 'shouldThrow',
            })}`
          )
    ...
    describe('clear:cookie', () => {
      beforeEach(() => {
        ...
        return sinon
          ...
          .withArgs({
            name: 'shouldThrow',
            url: 'http://cdn.github.com/assets',
          })
          .rejects({ message: 'some error' })
      })
