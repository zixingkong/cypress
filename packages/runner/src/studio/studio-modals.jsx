        ...
        <div className="body">
          ...
          <div className="content center">
            <div className="text">
              ...
              Studio will track events that generate the following commands:
            </div>
            ...
            <div className="text">
              ...
              <a href="https://on.cypress.io/studio-beta" target="_blank">
                feedback
              </a>{' '}
    ...
    return (
      ...
      >
        <div className="body">
          ...
          <div className="content center">
            <div className="text">
              Generate Cypress commands by interacting with your site as an end user would. Then, save these commands
              directly to your test file.
            </div>
        ...
        <div className="body">
          ...
          <div className="content">
            <form onSubmit={this._save}>
              <div className="text">
                <label className="text-strong" htmlFor="testName">
                  Test Name
                </label>
