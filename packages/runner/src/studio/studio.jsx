    ...
    return (
      <div className="header-popup studio">
        ...
        <div className="text-block">
          <span
            className={cs('icon', {
              'is-active': model.isActive && !model.isFailed && hasUrl,
            })}
          >
            <i className="fas" />
          </span>{' '}
          <span className="title">Studio</span> <span className="beta">Beta</span>
        </div>
        <div className="text-block">
          <a
            href="#"
            onClick={this._showModal}
            className={cs('available-commands', {
              'link-disabled': model.isLoading,
            })}
          >
            Available Commands
          </a>
        ...
        <div className="text-block">
          <a
            href={!model.isLoading ? 'https://on.cypress.io/studio-beta' : undefined}
            target="_blank"
            className={cs('give-feedback', {
              'link-disabled': model.isLoading,
            })}
          >
            Give Feedback
        ...
        <div className="studio-controls">
          <Tooltip title="Close Studio" className="cy-tooltip" visible={model.isLoading ? false : null}>
            <button
          ...
          <Tooltip title="Restart" className="cy-tooltip" visible={model.isLoading ? false : null}>
            <button
          ...
          <Tooltip title="Save Test" className="cy-tooltip" visible={model.isLoading ? false : null}>
            <button
