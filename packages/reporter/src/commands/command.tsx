  ...
  <span>
    ...
    <span
      ...
      dangerouslySetInnerHTML={{
        __html: formattedMessage(model.displayMessage || ''),
      }}
    />
  </span>
))
...
const Progress = observer(({ model }: ProgressProps) => {
  ...
  return (
    <div className="command-progress">
      <span
        style={{
          animationDuration: `${timeRemaining}ms`,
          transform: `scaleX(${percentageRemaining})`,
        }}
        key={timeRemaining}
      />
    </div>
            ...
            <div className="command-wrapper-text">
              ...
              <span className="command-controls">
                ...
                <span className="alias-container">
                  ...
                  >
                    <span
                      className={cs('num-duplicates', {
                        'has-alias': model.alias,
                      })}
                    >
                      {model.numDuplicates}
                    </span>
