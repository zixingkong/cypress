...
const ifThen = (condition: boolean, component: React.ReactNode) => (condition ? component : null)
    ...
    <div className="controls">
      ...
      {ifThen(
        ...
        >
          <button
            ...
            className={cs('toggle-auto-scrolling', {
              'auto-scrolling-enabled': appState.autoScrollingEnabled,
            })}
      ...
      {ifThen(
        ...
        <Tooltip
          ...
          title={
            <p>
              Stop Running <span className="kbd">S</span>
            </p>
          }
          className="cy-tooltip"
      ...
      {ifThen(
        ...
        <Tooltip
          ...
          title={
            <p>
              Run All Tests <span className="kbd">R</span>
            </p>
          }
          className="cy-tooltip"
        >
