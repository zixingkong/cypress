<template>
  <div class="home">
    <template v-if="crossword">
      <Clues
        v-for="(clues, direction) in crossword.clues"
        :key="direction"
        :class="direction"
        class="clues"
        :clues="clues"
      ...
      <section data-testid="crossword-section" class="crossword" :class="classes" :key="loading">
        <h1>Component Testing with Crosswords</h1>

        <p v-if="error">Houston, we have a problem:</p>
