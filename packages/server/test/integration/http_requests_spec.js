...
describe('Routes', () => {
      ...
      return config.set(obj).then((cfg) => {
        ...
        const open = () => {
          ...
          return Promise.all([
            ...
            this.server.open(cfg, this.project).spread(async (port) => {
        ...
        if (this.server) {
          return Promise.join(httpsServer.stop(), this.server.close()).then(open)
        }
  ...
  context('GET /', () => {
    ...
    it('does not redirect with _remoteOrigin set', function () {
      return this.setup('http://www.github.com').then(() => {
        nock(this.server._remoteOrigin).get('/').reply(200, '<html></html>', {
    ...
    it('does not redirect when visiting http site which isnt cypress server', function () {
      ...
      nock('http://www.momentjs.com').get('/').reply(200)

      return this.rp('http://www.momentjs.com/').then((res) => {
        expect(res.statusCode).to.eq(200)
    ...
    it('proxies through https', function () {
      return this.setup('https://localhost:8443').then(() => {
        return this.rp({
  ...
  context('GET /__', () => {
    ...
    it('routes config.clientRoute to serve cypress client app html', function () {
      return this.rp('http://localhost:2020/__').then((res) => {
        expect(res.statusCode).to.eq(200)
    ...
    it('proxies through https', function () {
      return this.setup('https://localhost:8443').then(() => {
        return this.rp('https://localhost:8443/__').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    it('routes when baseUrl is set', function () {
      return this.setup({ baseUrl: 'http://localhost:9999/app' }).then(() => {
        return this.rp('http://localhost:9999/__').then((res) => {
          expect(res.statusCode).to.eq(200)
  ...
  context('GET /__cypress/runner/*', () => {
    ...
    it('can get cypress_runner.js', function () {
      return this.rp('http://localhost:8443/__cypress/runner/cypress_runner.js').then((res) => {
        expect(res.statusCode).to.eq(200)
    ...
    it('can get cypress_runner.css', function () {
      return this.rp('http://localhost:8443/__cypress/runner/cypress_runner.css').then((res) => {
        expect(res.statusCode).to.eq(200)
  ...
  context('GET /__cypress/files', () => {
    ...
    describe('todos with specific configuration', () => {
      ...
      it('returns base json file path objects of only tests', function () {
        ...
        return glob(path.join(Fixtures.projectPath('todos'), 'tests', '_fixtures', '**', '*')).then((files) => {
          // make sure there are fixtures in here!
          expect(files.length).to.be.gt(0)

          return glob(path.join(Fixtures.projectPath('todos'), 'tests', '_support', '**', '*')).then((files) => {
  ...
  context('GET /__cypress/tests', () => {
    describe('ids with typescript', () => {
      ...
      it('processes foo.coffee spec', function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=cypress/integration/foo.coffee').then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('processes dom.jsx spec', function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=cypress/integration/baz.js').then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('serves error javascript file when the file is missing', function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=does/not/exist.coffee').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    describe('failures', () => {
      ...
      it("serves error javascript file when there's a syntax error", function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=cypress/integration/syntax_error.js').then((res) => {
          expect(res.statusCode).to.eq(200)
          expect(res.body).to.include('Cypress.action("spec:script:error", {')
    ...
    describe('no-server', () => {
      ...
      it('processes my-tests/test1.js spec', function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=my-tests/test1.js').then((res) => {
          expect(res.statusCode).to.eq(200)
          expect(res.body).to.match(sourceMapRegex)
      ...
      it('processes helpers/includes.js javascripts', function () {
        return this.rp('http://localhost:2020/__cypress/tests?p=helpers/includes.js').then((res) => {
          expect(res.statusCode).to.eq(200)
          expect(res.body).to.match(sourceMapRegex)
  ...
  context('ALL /__cypress/xhrs/*', () => {
    ...
    describe('delay', () => {
      ...
      it('does not call Promise.delay when no delay', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/xhrs/users/1').then((res) => {
          expect(res.statusCode).to.eq(200)
  ...
  context('GET /__cypress/iframes/*', () => {
    ...
    describe('todos', () => {
      ...
      it('renders iframe with variables passed in', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/iframes/integration/test2.coffee').then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('can send back all tests', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/iframes/__all').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    describe('no-server', () => {
      ...
      it('renders iframe with variables passed in', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/iframes/integration/test1.js').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    describe('e2e', () => {
      ...
      it('omits support directories', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/iframes/integration/app_spec.coffee').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    describe('ids', () => {
      ...
      it('renders iframe with variables passed in', function () {
        ...
        return this.rp('http://localhost:2020/__cypress/iframes/integration/foo.coffee').then((res) => {
          expect(res.statusCode).to.eq(200)
  ...
  context('GET *', () => {
    context('basic request', () => {
      ...
      it('basic 200 html response', function () {
        nock(this.server._remoteOrigin).get('/').reply(200, 'hello from bar!', {
          'Content-Type': 'text/html',
        })
    ...
    context('304 Not Modified', () => {
      ...
      it('sends back a 304', function () {
        nock(this.server._remoteOrigin).get('/assets/app.js').reply(304)
    ...
    context('redirects', () => {
      ...
      it('doesnt redirect with query params or hashes which werent in location header', function () {
        nock(this.server._remoteOrigin).get('/foo?bar=baz').reply(302, undefined, {
          Location: '/css',
        })
      ...
      it('sets cookies and removes __cypress.initial when initial is originally false', function () {
        nock(this.server._remoteOrigin).get('/css').reply(302, undefined, {
      ...
      return [301, 302, 303, 307, 308].forEach((code) => {
        it(`handles direct for status code: ${code}`, function () {
          return this.setup('http://auth.example.com').then(() => {
            nock(this.server._remoteOrigin).get('/login').reply(code, undefined, {
    ...
    context('error handling', () => {
      ...
      it('passes through status code + content', function () {
        nock(this.server._remoteOrigin).get('/index.html').reply(500, 'server error', {
          'Content-Type': 'text/html',
        })
      ...
      it('sends back socket hang up on request errors which match origin', function () {
        nock('http://app.github.com').get('/').replyWithError('ECONNREFUSED')
      ...
      it('sends back 404 when file does not exist locally', function () {
        return this.setup('<root>', {
          ...
          return this.rp(`${this.proxy}/foo/views/test/index.html`).then((res) => {
      ...
      it('does not inject on file server errors when origin does not match', function () {
        return this.setup('<root>', {
          ...
          nock('http://www.github.com').get('/index.html').reply(500, 'server error', {
            'Content-Type': 'text/html',
          })

          return this.rp('http://www.github.com/index.html').then((res) => {
            expect(res.statusCode).to.eq(500)
    ...
    context('headers', () => {
      ...
      describe('when initial is true', () => {
        it('sets back to false', function () {
          nock(this.server._remoteOrigin).get('/app.html').reply(200, 'OK', {
            'Content-Type': 'text/html',
          })
      ...
      it('sends with Transfer-Encoding: chunked without Content-Length', function () {
        nock(this.server._remoteOrigin).get('/login').reply(200, Buffer.from('foo'), {
          'Content-Type': 'text/html',
        })
      ...
      it('does not have Content-Length', function () {
        nock(this.server._remoteOrigin).get('/login').reply(200, 'foo', {
          'Content-Type': 'text/html',
          'Content-Length': 123,
        })
      ...
      it('forwards cookies from incoming responses', function () {
        nock(this.server._remoteOrigin).get('/login').reply(200, 'OK', {
      ...
      it('appends to previous cookies from incoming responses', function () {
        nock(this.server._remoteOrigin).get('/login').reply(200, '<html></html>', {
        ...
        return this.rp({
          ...
          expect(setCookie[1]).to.eq(
            '__cypress.initial=; Domain=localhost; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT'
          )
        })
      })

      it('appends cookies on redirects', function () {
        nock(this.server._remoteOrigin).get('/login').reply(302, undefined, {
          location: '/dashboard',
          'set-cookie': 'userId=123; Path=/',
        })
      ...
      it('forwards other headers from incoming responses', function () {
        nock(this.server._remoteOrigin).get('/auth').reply(200, 'OK', {
          'x-token': 'abc-123',
        })
      ...
      it('forwards headers to outgoing requests', function () {
        nock(this.server._remoteOrigin).get('/bar').matchHeader('x-custom', 'value').reply(200, 'hello from bar!', {
          'Content-Type': 'text/html',
        })
      ...
      it('omits x-frame-options', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, 'OK', {
          'Content-Type': 'text/html',
          'x-frame-options': 'SAMEORIGIN',
        })

        return this.rp('http://localhost:8080/bar').then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('does not modify host origin header', function () {
        return this.setup('http://foobar.com').then(() => {
          nock(this.server._remoteOrigin).get('/css').matchHeader('host', 'foobar.com').reply(200)
      ...
      it('does cache requesting resource without injection', function () {
        ...
        return this.rp('http://localhost:8080/').then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('issue #222 - correctly sets http host headers', function () {
        ...
        return matches('http://localhost:8080/app.css', () => {
          return nock('http://localhost:8080').matchHeader('host', 'localhost:8080').get('/app.css').reply(200, '{}', {
      ...
      context('authorization', () => {
        it('attaches auth headers when matches origin', function () {
          ...
          nock('http://localhost:8080').get('/index').matchHeader('authorization', `Basic ${base64}`).reply(200, '')
        ...
        it('does not modify existing auth headers when matching origin', function () {
          ...
          nock('http://localhost:8080').get('/index').matchHeader('authorization', existing).reply(200, '')
        ...
        it("doesn't attach auth headers to a diff protection space on the same origin", function () {
          return this.setup('http://beta.something.com').then(() => {
            const username = 'u'
            const password = 'p'
    ...
    context('images', () => {
      ...
      it('passes the bytes through without injection on http servers', function () {
        ...
        return Promise.all([
          ...
          nock(this.server._remoteOrigin).get('/javascript-logo.png').replyWithFile(200, image, {
      ...
      it('passes the bytes through without injection on http servers with gzip', function () {
        ...
        return Promise.all([
          ...
          nock(this.server._remoteOrigin).get('/javascript-logo.png').replyWithFile(200, zipped, {
            'Content-Type': 'image/png',
            'Content-Encoding': 'gzip',
          })
    ...
    context('woff', () => {
      ...
      it('passes the bytes through without injection', function () {
        ...
        return Promise.all([
          ...
          nock(this.server._remoteOrigin).get('/font.woff').replyWithFile(200, font, {
    ...
    context('svg', () => {
      ...
      it('rewrites <svg> without hanging', function () {
        ...
        nock(this.server._remoteOrigin).get('/bar').reply(200, contents, {
    ...
    context('content injection', () => {
      ...
      it('injects even when head tag is missing', function () {
        ...
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<html> <body>hello from bar!</body> </html>', {
          'Content-Type': 'text/html',
        })
      ...
      it('injects when head is capitalized', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<HTML> <HEAD>hello from bar!</HEAD> </HTML>', {
          'Content-Type': 'text/html',
        })
      ...
      it('injects when both head + body are missing', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<HTML>hello from bar!</HTML>', {
          'Content-Type': 'text/html',
        })
      ...
      it('injects even when html + head + body are missing', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<div>hello from bar!</div>', {
          'Content-Type': 'text/html',
        })
      ...
      it('injects after DOCTYPE declaration when no other content', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<!DOCTYPE>', {
          'Content-Type': 'text/html',
        })
      ...
      it('injects superdomain even when head tag is missing', function () {
        ...
        return this.rp({
          ...
          expect(res.body).to.eq(
            "<html> <head> <script type='text/javascript'> document.domain = 'google.com'; </script> </head> <body>hello from bar!</body> </html>"
          )
        })
      })

      it('injects content after following redirect', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(302, undefined, {
        ...
        return this.rp({
          ...
          return this.rp(res.headers['location']).then((res) => {
            expect(res.statusCode).to.eq(200)
            expect(res.headers['set-cookie']).to.match(/initial=;/)
      ...
      it('does not inject when not initial and not html', function () {
        nock(this.server._remoteOrigin).get('/bar').reply(200, '<html><head></head></html>', {
          'Content-Type': 'text/plain',
        })
      ...
      it('injects into https://www.google.com', function () {
        return this.setup('https://www.google.com').then(() => {
          this.server.onRequest((req, res) => {
            return nock('https://www.google.com').get('/').reply(200, '<html><head></head><body>google</body></html>', {
              'Content-Type': 'text/html',
            })
          })
      ...
      it('injects even on 5xx responses', function () {
        return this.setup('https://www.google.com').then(() => {
          this.server.onRequest((req, res) => {
            return nock('https://www.google.com').get('/').reply(500, '<html><head></head><body>google</body></html>', {
              'Content-Type': 'text/html',
            })
          })
      ...
      it('works with host swapping', function () {
        ...
        return this.setup('https://www.foobar.com:8443').then(() => {
      ...
      it('injects document.domain on https requests to same superdomain but different subdomain', function () {
        return this.setup('https://www.foobar.com:8443').then(() => {
          ...
          return this.rp({
            ...
            expect(body).to.eq(
              "<html><head> <script type='text/javascript'> document.domain = 'foobar.com'; </script></head><body>https server</body></html>"
            )
          })
        })
      })
      ...
      it('injects document.domain on other http requests', function () {
        nock(this.server._remoteOrigin).get('/iframe').reply(200, '<html><head></head></html>', {
          'Content-Type': 'text/html',
        })
        ...
        return this.rp({
          ...
          expect(body).to.eq(
            "<html><head> <script type='text/javascript'> document.domain = 'google.com'; </script></head></html>"
          )
        })
      })

      it('injects document.domain on matching super domains but different subdomain', function () {
        nock('http://mail.google.com').get('/iframe').reply(200, '<html><head></head></html>', {
          'Content-Type': 'text/html',
        })
      ...
      it('does not inject document.domain on non http requests', function () {
        nock(this.server._remoteOrigin).get('/json').reply(200, {
      ...
      it('does not inject document.domain on http requests which do not match current superDomain', function () {
        nock('http://www.foobar.com').get('/').reply(200, '<html><head></head><body>hi</body></html>', {
          'Content-Type': 'text/html',
        })
      ...
      it('does not inject anything when not text/html response content-type even when __cypress.initial=true', function () {
        nock(this.server._remoteOrigin).get('/json').reply(200, { foo: 'bar' })
    ...
    context('security rewriting', () => {
      describe('on by default', () => {
        ...
        it('replaces obstructive code in HTML files', function () {
          ...
          nock(this.server._remoteOrigin).get('/index.html').reply(200, html, {
            'Content-Type': 'text/html',
          })
          ...
          return this.rp({
            ...
            expect(res.body).to.include('<script>if (self !== self) { }</script>')
          })
        })

        it('replaces obstructive code in JS files', function () {
          nock(this.server._remoteOrigin).get('/app.js').reply(200, 'if (top !== self) { }', {
          ...
          return this.rp('http://www.google.com/app.js').then((res) => {
            ...
            expect(res.body).to.eq('if (self !== self) { }')
          })
        })
        ...
        it('handles multi-byte characters correctly when injecting', function () {
          ...
          return zlib.gzipAsync(response).then((resp) => {
            nock(this.server._remoteOrigin).get('/index.html').reply(200, resp, {
              'Content-Type': 'text/html',
              'Content-Encoding': 'gzip',
            })
        ...
        it('does not die rewriting a huge JS file', function () {
          ...
          const getHugeFile = () => {
            return rp('https://s3.amazonaws.com/internal-test-runner-assets.cypress.io/huge_app.js').then((resp) => {
              return fs.outputFileAsync(pathToHugeAppJs, resp).return(resp)
            })
          }
      ...
      describe('off with config', () => {
        ...
        it('can turn off security rewriting for HTML', function () {
          ...
          return this.rp({
            ...
            expect(res.body).to.include('<script>if (top !== self) { }</script>')
          })
        })
        ...
        it('does not replaces obstructive code in JS files', function () {
          ...
          return this.rp('http://www.google.com/app.js').then((res) => {
            ...
            expect(res.body).to.eq('if (top !== self) { }')
          })
        })
      })
    })
    ...
    context('file requests', () => {
      ...
      it('sets etag', function () {
        return this.rp(`${this.proxy}/assets/app.css`).then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('disregards anything past the pathname', function () {
        return this.rp(`${this.proxy}/assets/app.css?foo=bar#hash`).then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('can serve files with spaces in the path', function () {
        return this.rp(`${this.proxy}/a space/foo.txt`).then((res) => {
          expect(res.statusCode).to.eq(200)
      ...
      it('sets x-cypress-file-path headers', function () {
        return this.rp(`${this.proxy}/assets/app.css`).then((res) => {
          expect(res.headers).to.have.property(
            'x-cypress-file-path',
            `${Fixtures.projectPath('no-server')}/dev/assets/app.css`
          )
        })
      })

      it('sets x-cypress-file-server-error headers on error', function () {
        return this.rp(`${this.proxy}/does-not-exist.html`).then((res) => {
          expect(res.statusCode).to.eq(404)
    ...
    context('http requests', () => {
      beforeEach(function () {
        return this.setup('http://getbootstrap.com').then(() => {
          nock(this.server._remoteOrigin).get('/components').reply(200, 'content page', {
            'Content-Type': 'text/html',
          })

          return this.rp('http://getbootstrap.com/components').then((res) => {
            expect(res.statusCode).to.eq(200)
          })
        })
      })
      ...
      it('proxies http requests', function () {
        nock(this.server._remoteOrigin).get('/assets/css/application.css').reply(200, 'html { color: #333 }', {
          'Content-Type': 'text/css',
        })

        return this.rp('http://getbootstrap.com/assets/css/application.css').then((res) => {
          expect(res.statusCode).to.eq(200)
    ...
    context('when session is already set', () => {
      beforeEach(function () {
        return this.setup('http://getbootstrap.com').then(() => {
          ...
          // session proxy!
          nock(this.server._remoteOrigin).get('/css').reply(200, 'css content page', {
            'Content-Type': 'text/html',
          })

          return this.rp('http://getbootstrap.com/css').then((res) => {
            expect(res.statusCode).to.eq(200)
          })
        })
      })
    ...
    context('localhost', () => {
      ...
      it('makes requests to ipv6 when ipv4 fails', function (done) {
        ...
        return dns.lookup('localhost', { all: true }, (err, addresses) => {
          ...
          return server.listen(6565, '::', () => {
            return this.rp('http://localhost:6565/#/foo').then((res) => {
              expect(res.statusCode).to.eq(200)
      ...
      it('handles 204 no content status codes', function () {
        nock('http://localhost:6565').get('/user/rooms').reply(204, '')

        return this.rp('http://localhost:6565/user/rooms').then((res) => {
    ...
    context('blocked hosts', () => {
      beforeEach(function () {
        return this.setup({
          config: {
            blockHosts: ['*.google.com', 'shop.apple.com', 'cypress.io', 'localhost:6666', '*adwords.com'],
          },
        })
      })
    ...
    context('client aborts', () => {
      ...
      it('aborts the proxied request', function (done) {
        fs.readFileAsync(Fixtures.path('server/libs/huge_app.js'), 'utf8').then((str) => {
          const server = http.createServer((req, res) => {
    ...
    context('event source / server sent events / SSE', () => {
      ...
      beforeEach(function () {
        ...
        return this.setup('http://localhost:5959', {
          ...
          return this.srv.listenAsync().then(() => {
      ...
      it('receives event source messages through the proxy', function (done) {
        onRequest = function (req, res) {
          ...
          return Promise.join(aborted, closed).then(() => {
            return done()
          })
        }
    ...
    context('when body should be empty', function () {
      ...
      beforeEach(function (done) {
        ...
        return this.httpSrv.listen(() => {
          ...
          return this.setup(`http://localhost:${this.port}`).then(_.ary(done, 0))
        })
      })
  ...
  context('POST *', () => {
    ...
    it('does not fail on a big cookie', function () {
      nock(this.server._remoteOrigin).post('/login').reply(200)
      ...
      return this.rp({
        ...
        body: {
          query: {
            bool: {
              must: [
                { filtered: { filter: { term: { brand_id: 3 } } } },
                { filtered: { filter: { term: { is_live: true } } } },
                {
                  filtered: {
                    filter: {
                      bool: {
                        should: [{ term: { subcategory_id: 25 } }, { term: { subcategory_id: 21 } }],
                      },
                    },
                  },
                },
          ...
          aggs: {
            'colors.raw3': {
              filter: {},
              aggs: {
                'colors.raw': { terms: { field: 'colors.raw', size: 50 } },
                'colors.raw_count': { cardinality: { field: 'colors.raw' } },
              },
            },
            'patterns.raw4': {
              filter: {},
              aggs: {
                'patterns.raw': { terms: { field: 'patterns.raw', size: 50 } },
                'patterns.raw_count': {
                  cardinality: { field: 'patterns.raw' },
                },
              },
            },
            'custom_filters_a.raw5': {
              filter: {},
              aggs: {
                'custom_filters_a.raw': {
                  terms: { field: 'custom_filters_a.raw', size: 50 },
                },
                'custom_filters_a.raw_count': {
                  cardinality: { field: 'custom_filters_a.raw' },
                },
              },
            },
            'custom_filters_b.raw6': {
              filter: {},
              aggs: {
                'custom_filters_b.raw': {
                  terms: { field: 'custom_filters_b.raw', size: 50 },
                },
                'custom_filters_b.raw_count': {
                  cardinality: { field: 'custom_filters_b.raw' },
                },
              },
            },
          },
