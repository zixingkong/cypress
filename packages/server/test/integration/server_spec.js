      ...
      it('buffers the response', function () {
        ...
        return this.server
          ...
          .then((obj = {}) => {
            ...
            expect(this.buffers.buffer).to.include({
              url: 'http://localhost:2000/index.html',
            })
          })
          .then(() => {
          ...
          .then(() => {
            return this.rp('http://getbootstrap.com/').then((res) => {
              ...
              expect(res.body).to.include(
                "Cypress.action('app:window:before:load', window); </script> </head>content</html>"
              )
            })
          })
      })
        ...
        return this.server
          ...
          .then(() => {
            return this.rp('http://espn.go.com/').then((res) => {
              ...
              expect(res.body).to.include(
                "Cypress.action('app:window:before:load', window); </script></head><body>espn</body></html>"
              )
        ...
        return this.server
          ...
          .then(() => {
            return this.rp('http://www.google.com/').then((res) => {
              ...
              expect(res.body).to.include(
                "Cypress.action('app:window:before:load', window); </script></head><body>google</body></html>"
              )
            })
          })
          .then(() => {
        ...
        return this.server
          ...
          .then(() => {
            return this.rp('https://www.foobar.com:8443/').then((res) => {
              ...
              expect(res.body).to.include(
                "Cypress.action('app:window:before:load', window); </script></head><body>https server</body></html>"
              )
            })
          })
          .then(() => {
