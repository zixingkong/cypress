  ...
  runs: [
    {
      ...
      tests: [
              ...
              screenshots: [
                {
                  ...
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- beforeEach hooks -- never gets here -- before each hook (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
        ...
        {
          title: ['simple failing hook spec', 'pending', 'is pending'],
          state: 'pending',
          body: '',
          displayError: null,
          attempts: [
        ...
        {
          title: ['simple failing hook spec', 'afterEach hooks', 'runs this'],
          state: 'failed',
          body: 'function () {}',
          displayError:
            'Error: fail2\n\nBecause this error occurred during a `after each` hook we are skipping the remaining tests in the current suite: `afterEach hooks`\n      [stack trace lines]',
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- afterEach hooks -- runs this -- after each hook (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
        ...
        {
          title: ['simple failing hook spec', 'afterEach hooks', 'does not run this'],
          state: 'skipped',
          body: 'function () {}',
          displayError: null,
          attempts: [
        ...
        {
          title: ['simple failing hook spec', 'after hooks', 'runs this'],
          state: 'passed',
          body: 'function () {}',
          displayError: null,
          attempts: [
        ...
        {
          title: ['simple failing hook spec', 'after hooks', 'fails on this'],
          state: 'failed',
          body: 'function () {}',
          displayError:
            'Error: fail3\n\nBecause this error occurred during a `after all` hook we are skipping the remaining tests in the current suite: `after hooks`\n      [stack trace lines]',
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- after hooks -- fails on this -- after all hook (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
    ...
    },
    {
      ...
      tests: [
        {
          title: ['simple failing spec', 'fails1'],
          state: 'failed',
          body: "function () {\n    cy.wrap(true, {\n      timeout: 100\n    }).should('be.false');\n  }",
          displayError:
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_spec.js/simple failing spec -- fails1 (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
        ...
        {
          title: ['simple failing spec', 'fails2'],
          state: 'failed',
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_spec.js/simple failing spec -- fails2 (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
    ...
    },
    {
      ...
      tests: [
        {
          title: ['simple passing spec', 'passes'],
          state: 'passed',
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- beforeEach hooks -- never gets here (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- beforeEach hooks -- never gets here -- before each hook (failed) (attempt 2).png',
                  height: 720,
                  width: 1280,
                },
              ],
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_failing_hook_spec.js/simple failing hook spec -- afterEach hooks -- runs this -- after each hook (failed) (attempt 2).png',
                  height: 720,
                  width: 1280,
                },
              ],
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_retrying_spec.js/simple retrying spec -- t1 (failed).png',
                  height: 720,
                  width: 1280,
                },
              ],
              ...
              screenshots: [
                {
                  ...
                  takenAt: '2018-02-01T20:14:19.323Z',
                  path:
                    '/foo/bar/.projects/e2e/cypress/screenshots/simple_retrying_spec.js/simple retrying spec -- t1 (failed) (attempt 2).png',
                  height: 720,
                  width: 1280,
                },
              ],
