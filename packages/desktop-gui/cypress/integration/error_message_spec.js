describe('Error Message', function () {
  beforeEach(function () {
    ...
    this.detailsErr = {
      name: 'Error',
      message:
        'This is an error message explaining an event. Learn more about this event in the error details section.',
      stack: '[object Object]↵',
      details:
        'ReferenceError: alsdkjf is not defined\n \
...
\tat process._tickCallback (internal/process/next_tick.js:180:9)',
  ...
  it('displays normal error message', function () {
    ...
    cy.get('.error').should('contain', this.err.message)
  ...
  it('displays error message with html escaped', function () {
    this.err.message =
      "Error reading from: <span class='ansi-blur-gf'>/Users/cypress.json</span><br /><br /> <span class='ansi-yellow-fg'>SyntaxError</span>"
    this.ipc.openProject.rejects(this.err)
    this.start()

    cy.get('.error').should('contain', 'Error reading from: /Users/cypress.json').should('not.contain', '<span')
  })
  ...
  it('displays Port in Use instructions on err', function () {
    ...
    cy.get('.error').should('contain', this.err.message).and('contain', 'To fix')
  })
  ...
  it('renders markdown', function () {
    ...
    cy.get('.error').should('not.contain', this.withMarkdown).should('contain', 'this is markdown')
  })
