...
;(function (global, factory) {
  ...
  let // Swappable if display is none or starts with table
  ...
  function getWidthOrHeight(elem, name, extra) {
    ...
    return `${
      val + augmentWidthOrHeight(elem, name, extra || (isBorderBox ? 'border' : 'content'), valueIsBorderBox, styles)
    }px`
  }
  ...
  jQuery.extend(jQuery.event, {
    ...
    simulate(type, elem, event) {
      let e = jQuery.extend(new jQuery.Event(), event, {
        type,
        isSimulated: true,
      })
  ...
  jQuery.param = function (a, traditional) {
    let prefix,
      ...
      add = function (key, valueOrFunction) {
        ...
        let value = jQuery.isFunction(valueOrFunction) ? valueOrFunction() : valueOrFunction
  ...
  let // Map over jQuery in case of overwrite
